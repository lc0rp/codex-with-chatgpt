...
1. Check the environment: git and Node.js >= 20 must be available. Install
   ...
   cloudflared.
2. Download: clone https://github.com/lc0rp/codex-with-chatgpt into
...
new version is released; no action needed. You can also tell Codex
"Update Codex with ChatGPT" anytime.

---

*The sections below are in English. For the complete Chinese version, see
