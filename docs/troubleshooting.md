...
If doctor says the bridge state is **uncertain** (state could not be confirmed), do not start a
...
this workspace, with **project-only memory**. Tell Codex "done" when the
